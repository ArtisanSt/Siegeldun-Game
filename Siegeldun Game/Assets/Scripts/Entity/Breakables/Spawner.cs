...
public class Spawner : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        levelMobs.Add("Goblin");
        MobSpawner mobInstance = new MobSpawner(AssetDatabase.LoadAssetAtPath<UnityEngine.GameObject>($"Assets/Prefabs/EntityPrefabs/Goblin.prefab"), 20);
        mobPrefabs.Add("Goblin", mobInstance);
